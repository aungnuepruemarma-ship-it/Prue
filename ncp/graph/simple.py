...
@dataclass
class SimpleGraph:
    """Generic string-keyed directed graph backing MemoryGraph.

    The UUID-keyed knowledge graph lives in ncp.graph.graph.Graph; this
    lightweight variant serves runtime views keyed by entity-id strings.
    """
